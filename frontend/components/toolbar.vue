<template>
  <v-toolbar color="grey darken-4" dark fixed app clipped-right>
    <!--<v-toolbar-side-icon @click.stop="state.drawer = !state.drawer"></v-toolbar-side-icon>-->
    
    <v-toolbar-title>
        <router-link class="toolbar-title" to="/">
          <img height="36px" src="~/assets/icon-dark.png">
        </router-link>
      </v-toolbar-title>

      <!--<v-btn class="mt-12" color="white" light small align-left href="/">
      Inicio
    </v-btn>
    <v-btn class="mt-12" color="white" light small align-left href="/">
      Contato  
    </v-btn>-->
    <v-btn depressed small dark color="grey darken-4" href="/">Ínicio</v-btn>
    <v-btn depressed small dark color="grey darken-4">Contato</v-btn>
    <v-btn depressed small dark color="grey darken-4">Sobre nós</v-btn>
